...
--    2026-07-30
update players set stack = stack - 50   where id = '7f15cd37-4201-49e4-8fa1-5f109a4d078a';
--    2026-08-04
update players set stack = stack - 50   where id = '4ccc1198-d596-45ea-8332-d82fd384b381';
update players set stack = stack - 50   where id = '1abc076c-07cf-4962-8d88-e08b82e796b2';
--    2026-08-05
update players set stack = stack - 175  where id = 'b47bbdaa-1268-4b43-a4cb-7a54ed51fa41';
update players set stack = stack - 50   where id = 'fd9e5db0-2d73-4cbd-a970-2d0da52c1806';
--    2026-08-06
update players set stack = stack - 50   where id = '6777fe47-216c-4155-8643-7f590bd09e47';
update players set stack = stack - 50   where id = '92ad3bfc-c55f-492f-8547-3e6d8b6eefd5';
update players set stack = stack - 50   where id = '70094891-a50f-4f6a-954c-a00f25c5fc4f';
update players set stack = stack - 50   where id = '6d391b80-78e3-4aad-8abe-439cc29e4e79';
--    2026-08-12
update players set stack = stack - 690  where id = '4c148eb7-8cd7-4fdf-be80-f15b33f11f57';
update players set stack = stack - 690  where id = 'a751cfc2-4aac-4408-8256-c979a76cf004';
update players set stack = stack - 460  where id = '36ccdd6b-b541-4056-b893-7956e9b932c5';
update players set stack = stack - 20   where id = '3a8ad483-1712-4028-9cd1-683996b7c294';
update players set stack = stack - 20   where id = '8039a5cb-e314-4cd9-a19f-5cc510cfdb8b';
--    2026-08-14
update players set stack = stack - 2590 where id = '596a0b25-5e5f-4bef-8993-48d6c033037c';
update players set stack = stack - 460  where id = '98cfd1e5-a11e-4f76-9525-b0fc08672bcc';
update players set stack = stack - 240  where id = 'acccfedc-806d-4f6f-a691-e3df3f0b5bbe';

-- 2. return chips left stranded in the pot, and close those pots
update players set stack = stack + 50  , hand_total_bet = 0 where id = '70fd069c-e071-402e-9d3e-8a804aacf2eb';  -- 2026-07-28
update players set stack = stack + 25  , hand_total_bet = 0 where id = '6024ca07-e663-4ea9-9029-135e56fe4293';  -- 2026-07-28
update players set stack = stack + 25  , hand_total_bet = 0 where id = 'daad3a94-be34-4257-b958-a6552ab87c6c';  -- 2026-07-29
update players set stack = stack + 50  , hand_total_bet = 0 where id = '8827b9e8-abcd-4d17-bfbe-636ae49b0ec1';  -- 2026-07-29
